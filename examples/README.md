# Interest Rate API - Examples

This folder contains example code for using the Interest Rate API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/interestrate',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/interestrate");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/interestrate](https://docs.apiverve.com/ref/interestrate)
