...
namespace APIVerve\Interestrate;
...
/**
 * Client for the Interest Rate API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/interestrate?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/interestrate';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\InterestrateClient] {$message}\n";
        }
    }
}
