// Package interestrate provides a Go client for the Interest Rate API.
//
// For more information, visit: https://apiverve.com/marketplace/interestrate?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/interestrate"
	defaultTimeout = 30 * time.Second
)

// Client is the Interest Rate API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Interest Rate API client.
...
// Execute makes a request to the Interest Rate API with typed parameters.
//
...
//   - country (required): string - 2-letter country code [minLength: 2, maxLength: 2]
