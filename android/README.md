...
```gradle
dependencies {
    implementation 'com.github.apiverve:interestrate-api:1.1.14'
}
```
...
```java
import com.apiverve.interestrate.InterestRateAPIClient;
import com.apiverve.interestrate.APIResponse;
import com.apiverve.interestrate.APIException;

// Initialize the client
InterestRateAPIClient client = new InterestRateAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/interestrate](https://docs.apiverve.com/ref/interestrate)
...
- **Documentation:** [https://docs.apiverve.com/ref/interestrate](https://docs.apiverve.com/ref/interestrate)
- **Issues:** [GitHub Issues](https://github.com/apiverve/interestrate-api/issues)
