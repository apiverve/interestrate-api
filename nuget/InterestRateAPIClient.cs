...
namespace APIVerve.API.InterestRate
{
    ...
    /// <summary>
    /// Client for the InterestRate API
    /// </summary>
    public class InterestRateAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/interestrate";
        ...
        {
            { "country", new ValidationRule { Type = "string", Required = true, MinLength = 2, MaxLength = 2 } },
            { "date", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public InterestRateAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InterestRateAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InterestRateAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, InterestRateQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(InterestRateQueryOptions options)
        {
        ...
        public ResponseObj Execute(InterestRateQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(InterestRateQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(InterestRateQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(InterestRateQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(InterestRateQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(InterestRateQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(InterestRateQueryOptions options)
        {
